...
namespace Fungus
{
    ...
    public class WriterAudio : MonoBehaviour, IWriterListener
    {
        ...
        [SerializeField] public int frequencyPlay = 5;
        private int currentGlyth = 0;
        ...
        public virtual void OnGlyph()
        {
            ...
            if (currentGlyth % frequencyPlay != 0) { currentGlyth++; return; }
            currentGlyth++;
            targetAudioSource.Stop();
            targetAudioSource.PlayOneShot(beepSounds[Random.Range(0, beepSounds.Count)]);
            /*
